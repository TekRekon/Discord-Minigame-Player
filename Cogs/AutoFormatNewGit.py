        ...
        if message.channel == AutoFormatNewGit.botUpdatesChannel:
            if message.author != self.bot.user:
                ...
                if old_embed.title is not None:
                    ...
                    git_embed = discord.Embed(title='\u200b', color=0xff0000)
                ...
                if old_embed.author.name is not None and old_embed.author.icon_url is not None:
                    ...
                    git_embed.set_author(name=old_embed.author.name)
                elif message.author.icon_url is not None:
                    git_embed.set_author(name='\u200b', icon_url=old_embed.author.icon_url)
